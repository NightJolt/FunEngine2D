...
fun::render::primitive_t::primitive_t(std::vector <sf::Vertex>& vertices, sf::PrimitiveType primitive_type) : m_vertices(std::move(vertices)), m_primitive_type(primitive_type) {}

std::vector <sf::Vertex>& fun::render::primitive_t::get_vertices() {
    return m_vertices;
}

void fun::render::primitive_t::set_vertices(const std::vector <sf::Vertex>& vertices) {
